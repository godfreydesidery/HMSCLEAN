...
@Entity
@Table(name = "md_diagnosis_type", uniqueConstraints = @UniqueConstraint(name = "uk_md_diagnosis_type_code", columnNames = "code"))
@Getter
...
public class DiagnosisType extends AuditableEntity {
    ...
    public DiagnosisType(String code, String name, String description) {
        this.code = code;
        this.name = name;
