...
/**
 * One medicine line on a Transfer Order. The {@link #issuedQuantity} is the
 * sum of the picks recorded against this line (see
 * {@link StoreToPharmacyTOBatchPick}); it caps at {@link #requestedQuantity}.
 *
 * <p>The {@link #roLineUid} pointer back to the source RO line lets us roll
 * fulfilment forward on the RO as picks are recorded.
 */
@Entity
@Table(name = "store_to_pharmacy_to_line",
       indexes = {
               @Index(name = "idx_s2p_to_line_to",       columnList = "to_uid"),
               @Index(name = "idx_s2p_to_line_ro_line",  columnList = "ro_line_uid"),
               @Index(name = "idx_s2p_to_line_medicine", columnList = "medicine_uid")
       })
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class StoreToPharmacyTOLine extends AuditableEntity {
    ...
    public StoreToPharmacyTOLine(String toUid, String roLineUid, String medicineUid,
