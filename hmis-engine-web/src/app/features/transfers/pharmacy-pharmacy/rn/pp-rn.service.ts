...
export class PpRNService {
  private readonly http = inject(HttpClient);
  private readonly base = `${environment.apiUrl}/transfers/pharmacy-pharmacy/rn`;
  private readonly toBase = `${environment.apiUrl}/transfers/pharmacy-pharmacy/to`;
