...
import { CreateRORequest, RODto, ROSearchParams, ROSummary } from './pp-ro.types';

@Injectable({ providedIn: 'root' })
export class PpROService {
  private readonly http = inject(HttpClient);
  private readonly base = `${environment.apiUrl}/transfers/pharmacy-pharmacy/ro`;
