...
import { TOSummary } from './pp-to.types';

@Component({
  selector: 'app-pp-to-list',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RouterLink],
  templateUrl: './pp-to-list.component.html'
})
export class PpToListComponent {
  ...
  newOrder(): void { void this.router.navigate(['/transfers/pp/to/new']); }
  view(o: TOSummary): void { void this.router.navigate(['/transfers/pp/to', o.uid]); }
