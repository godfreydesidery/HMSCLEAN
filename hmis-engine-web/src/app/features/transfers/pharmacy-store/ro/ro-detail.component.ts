...
export class RoDetailComponent {
  ...
  back(): void { void this.router.navigate(['/transfers/ro']); }
  ...
  private runAction(call: (uid: string) => ReturnType<RoService['verify']>, successMsg: string): void {
