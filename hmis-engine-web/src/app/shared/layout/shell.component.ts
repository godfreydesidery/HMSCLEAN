  ...
  private readonly allGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Transfer queue', path: '/encounters/transfer-queue', icon: 'bi-arrow-left-right', privileges: ['ENCOUNTER_ACCESS'] },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Cashier',     path: '/billing/cashier', icon: 'bi-cash-coin',     privileges: ['BILLING_ACCESS'] },
        { label: 'Invoices',    path: '/billing',     icon: 'bi-receipt',          privileges: ['BILLING_ACCESS'] },
        { label: 'Cashier shift', path: '/billing/cashier-shift', icon: 'bi-cash-stack', privileges: ['BILLING_ACCESS'] },
        { label: 'Insurance claims', path: '/billing/claims', icon: 'bi-file-medical', privileges: ['BILLING_ACCESS'] },
